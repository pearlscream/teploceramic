            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right for_js"><?php echo $product['price']; ?></td>
                  <td class="text-right for_js"><?php echo $product['total']; ?></td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  ...
                  <td class="text-right for_js"><?php echo $total['text']; ?></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
