(function(e) {
    ...
    t.o = function() {
        ...
        this.run = function() {
            ...
            this.o = e.extend({
                ...
                width: this.$.data("width") || 94, //ширина
                height: this.$.data("height") || 94,
                displayInput: this.$.data("displayinput") == null || this.$.data("displayinput"),
                displayPrevious: this.$.data("displayprevious"),
                fgColor: this.$.data("fgcolor") || "#FF4500", // сделать оранжевым
    ...
    t.Dial = function() {
        ...
        this.extend = function() {
            this.o = e.extend({
                bgColor: this.$.data("bgcolor") || "rgba( 255, 0, 0, 0)", // бекграунд колор
